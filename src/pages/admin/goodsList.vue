...
<template>
  ...
  >
        ...
        <div class="preview-wrap-table">
          ...
          <main class="preview-content">
            <div style="flex: 3" class="column">
              ...
              <div
                :style="`
                        ...
                        padding-left: .5rem;
                    `"
                v-for="(data, index) in displayTableValue"
                class="row"
              >
                {{ data.cn }}
              </div>
            ...
            <div style="flex: 6" class="column">
              ...
              <div
                :style="`background: ${index % 2 === 0 ? '#93dcfd' : 'white'};`"
                v-for="(data, index) in displayTableValue"
                class="row"
              >
    ...
    <div v-if="loading" class="modal goods transparent">
      <div class="modal-mask loading">加载中...</div>
    </div>
